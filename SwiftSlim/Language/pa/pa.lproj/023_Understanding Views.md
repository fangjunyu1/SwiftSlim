...
### ਜੇ ਅਸੀਂ View ਦੀ ਪਾਲਣਾ ਨਾ ਕਰੀਏ ਤਾਂ ਕੀ ਹੁੰਦਾ ਹੈ?
...
## body view ਦਿਖਾਉਣ ਦਾ entry point ਹੈ
...
### body ਨਾਮ ਮਨਮਰਜ਼ੀ ਨਾਲ ਨਹੀਂ ਬਦਲਿਆ ਜਾ ਸਕਦਾ
...
**some View return type ਨੂੰ ਸੌਖਾ ਕਰਦਾ ਹੈ**
...
### some View ਮਨਮਰਜ਼ੀ ਨਾਲ ਕੋਈ ਵੀ view return ਨਹੀਂ ਕਰ ਸਕਦਾ
...
### body ਵਿੱਚ ਕਈ views ਸਿੱਧੇ ਕਿਉਂ ਲਿਖ ਸਕਦੇ ਹਾਂ?
...
struct ContentView: View {
    var body: some View {
        VStack(spacing: 30) {
            ...
            Button("ਮੈਨੂੰ ਕਲਿੱਕ ਕਰੋ") {
                print("ਮੈਨੂੰ ਕਲਿੱਕ ਕਰੋ ")
            }
...
var topਘਰ: some View {
    HStack {
        Text("ਘਰ")
            .font(.largeTitle)
        Spacer()
        Image(systemਨਾਮ: "bell")
    }
}
```

Here, `topਘਰ` is a variable that returns a view.
...
### some View ਇੱਕੋ view return ਕਰਦਾ ਹੈ
...
In this code, `topਘਰ` returns either `HStack` or `Text` depending on the content of `step`, which are two different view types.
...
### ਵੱਖ ਕੀਤੇ views parentheses ਕਿਉਂ ਨਹੀਂ ਵਰਤਦੇ
...
**Properties ਨੂੰ parentheses ਦੀ ਲੋੜ ਨਹੀਂ ਹੁੰਦੀ।**
