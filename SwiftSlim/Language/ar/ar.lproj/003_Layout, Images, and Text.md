...
مثلاً، إذا أردنا تنفيذ جزء علوي شبيه بموقع [NHK](https://www3.nhk.or.jp/nhkworld/zh/news/)، حيث يظهر شعار NHK في الجهة اليسرى وأيقونة القائمة في الجهة اليمنى.
...
على سبيل المثال: [Google](https://www.google.com/)
