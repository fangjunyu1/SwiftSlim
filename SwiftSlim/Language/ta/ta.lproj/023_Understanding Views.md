# காட்சிகளைப் புரிந்துகொள்ளுதல்

இந்தப் பாடத்தில், நாம் முதலில் இருந்த `ContentView` க்கு மீண்டும் திரும்புகிறோம்.
...
நாம் முதன்முதலில் SwiftUI-ஐ பார்த்தபோது, `ContentView` உள்ளே நமக்குப் புரியாத பல keywords இருந்தன.

உதாரணமாக `struct`, `View`, `var`, `body`, `some View` போன்ற keywords.

அப்போது நமக்குத் தெரிந்திருந்தது இதுவாக மட்டுமே இருக்கலாம்: **`body` உள்ளே code எழுதினால், content திரையில் தோன்றும்.**

இப்போது `struct`, variables, methods, protocols ஆகியவற்றைக் கற்றுள்ளோம்; எனவே இந்த code-ஐ மீண்டும் புரிந்து, SwiftUI views இடையேயான தொடர்பை புரிந்துகொள்ளலாம்.

## ContentView ஐ மீண்டும் பார்க்குதல்

SwiftUI project உருவாக்கிய பிறகு, Xcode default ஆக ஒரு `ContentView` file உருவாக்கும்.

உதாரண code பின்வருமாறு:
...
இந்த code-ஐ பல பகுதிகளாகப் பிரித்து புரிந்துகொள்ளலாம்.
...
இந்த வரி SwiftUI framework-ஐ import செய்கிறது.

SwiftUI-ஐ import செய்த பிறகு, `View`, `Text`, `Image`, `VStack`, `Button` போன்ற SwiftUI views பயன்படுத்தலாம்.

## ContentView structure

இந்த code வரி ஒரு structure உருவாக்குகிறது:
...
`ContentView` ஒரு structure என்பதை குறிக்கிறது.

முந்தைய பாடத்தில் `struct` பற்றி கற்றோம். அது தொடர்புடைய fields-ஐ ஒன்றாகக் குழுமப்படுத்த முடியும்; properties மற்றும் methods-ஐ கொண்டிருக்க முடியும்.
...
இந்த example-இல், `ContentView` மூன்று விஷயங்களை கொண்டுள்ளது: `name`, `printName`, `body`.

வேறுவிதமாகச் சொன்னால், `struct` தொடர்புடைய properties, methods, view content ஆகியவற்றை ஒன்றாகக் குழுமப்படுத்த முடியும்.

![contentView](../../Resource/023_contentVIew.png)

## View என்பது ஒரு protocol

இந்த code வரியைத் தொடர்ந்து பாருங்கள்:

```swift
struct ContentView: View 
```

colon-க்கு பின்வரும் `View`, `ContentView` `View` protocol-ஐ பின்பற்றுகிறது என்பதை குறிக்கிறது.

இதை இவ்வாறு புரிந்துகொள்ளலாம்: `ContentView` SwiftUI view ஆக வேண்டுமெனில், அது `View` protocol-ன் requirements-ஐ பூர்த்தி செய்ய வேண்டும்.
...
### View-ஐ பின்பற்றவில்லை என்றால் என்ன ஆகும்?
...
## body என்பது view காட்டுவதற்கான entry point
...
### body என்ற பெயரை விருப்பப்படி மாற்ற முடியாது
...
**some View return type-ஐ எளிதாக்குகிறது**
...
### some View எந்த view-யையும் சுதந்திரமாக return செய்ய முடியாது
...
### body பல views-ஐ நேரடியாக ஏன் கொண்டிருக்க முடியும்?
...
**முதலில் containers பயன்படுத்து**
...
struct ContentView: View {
    var body: some View {
        VStack(spacing: 30) {
            ...
            Button("என்னை கிளிக் செய்") {
                print("என்னை கிளிக் செய் ")
            }
...
### மேல் view-ஐ பிரித்தல்

For example, split out the top area:

```swift
var topமுகப்பு: some View {
    HStack {
        Text("முகப்பு")
            .font(.largeTitle)
        Spacer()
        Image(systemபெயர்: "bell")
    }
}
```

Here, `topமுகப்பு` is a variable that returns a view.
...
### some View ஒரு view மட்டும் return செய்கிறது
...
In this code, `topமுகப்பு` returns either `HStack` or `Text` depending on the content of `step`, which are two different view types.
...
### பிரிக்கப்பட்ட views parentheses ஏன் பயன்படுத்தவில்லை
...
**Properties-க்கு parentheses தேவையில்லை.**
...
## View property அல்லது புதிய view?
...
### View properties எப்போது பயன்படுத்துவது
...
### புதிய view எப்போது உருவாக்குவது
