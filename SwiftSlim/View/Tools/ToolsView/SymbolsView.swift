...
struct SingleSymbols: Identifiable {
    ...
    static let listSymbols: [SingleSymbols] = [
        ...
        SingleSymbols(name: "eraser",                    version: .SF3, keywords: ["橡皮", "擦除", "清除", "撤销", "删除"]),
        SingleSymbols(name: "square.and.pencil",         version: .SF1, keywords: ["编辑", "修改", "写作", "新建", "起草"]),
        SingleSymbols(name: "scribble",                  version: .SF1, keywords: ["笔迹", "涂鸦", "手写", "绘图", "草稿"]),
        ...
        SingleSymbols(name: "archivebox",                version: .SF1, keywords: ["存档盒", "归档", "存储", "压缩", "打包"]),
        ...
        SingleSymbols(name: "document.on.document",      version: .SF6, keywords: ["拷贝文件", "复制文档", "复制", "副本"]),
        SingleSymbols(name: "clipboard",                 version: .SF1, keywords: ["剪贴板", "粘贴", "复制", "记录", "任务"]),
        SingleSymbols(name: "text.page",                 version: .SF1, keywords: ["文本页", "文档页", "页面", "文章", "内容"]),
        SingleSymbols(name: "note",                      version: .SF1, keywords: ["笔记", "便签", "备忘", "记录", "提醒"]),
        ...
        SingleSymbols(name: "menucard",                  version: .SF2, keywords: ["菜单", "点餐", "餐厅", "选项", "列表"]),
        ...
        SingleSymbols(name: "person.3",                  version: .SF2, keywords: ["三人", "团队", "群组", "多人", "协作"]),
        ...
        SingleSymbols(name: "person.crop.artframe",      version: .SF4, keywords: ["个人相框", "头像框", "联系人图片", "照片"]),
        ...
        SingleSymbols(name: "figure.stand.dress.line.vertical.figure", version: .SF4, keywords: ["厕所", "卫生间", "洗手间", "男女", "标识"]),
        ...
        SingleSymbols(name: "figure",                    version: .SF4, keywords: ["人物", "用户", "个人", "行人", "形象"]),
        SingleSymbols(name: "accessibility",             version: .SF1, keywords: ["辅助功能", "无障碍", "残障", "轮椅", "包容"]),
        ...
        SingleSymbols(name: "figure.roll",               version: .SF4, keywords: ["轮椅", "残障", "辅助", "无障碍", "滚动"]),
        ...
        SingleSymbols(name: "baseball",                  version: .SF2, keywords: ["棒球", "球类", "运动", "体育"]),
        SingleSymbols(name: "basketball",                version: .SF2, keywords: ["篮球", "球类", "运动", "体育", "NBA"]),
        SingleSymbols(name: "american.football",         version: .SF2, keywords: ["橄榄球", "美式足球", "NFL", "球类", "运动"]),
        SingleSymbols(name: "tennis.racket",             version: .SF4, keywords: ["网球拍", "网球", "运动", "球拍", "体育"]),
        SingleSymbols(name: "hockey.puck",               version: .SF2, keywords: ["冰球", "冰上运动", "球类", "体育"]),
        SingleSymbols(name: "tennisball",                version: .SF2, keywords: ["网球", "球类", "运动", "体育"]),
        SingleSymbols(name: "volleyball",                version: .SF4, keywords: ["排球", "球类", "运动", "体育"]),
        SingleSymbols(name: "skateboard",                version: .SF2, keywords: ["滑板", "极限运动", "户外", "娱乐"]),
        SingleSymbols(name: "snowboard",                 version: .SF4, keywords: ["单板滑雪", "滑雪", "冬季运动", "雪地"]),
        SingleSymbols(name: "surfboard",                 version: .SF4, keywords: ["冲浪板", "冲浪", "水上运动", "海浪"]),
        SingleSymbols(name: "duffle.bag",                version: .SF4, keywords: ["旅行包", "运动包", "行李", "健身包"]),
        ...
        SingleSymbols(name: "fn",                        version: .SF1, keywords: ["功能键", "Fn", "键盘", "快捷键"]),
        SingleSymbols(name: "power",                     version: .SF1, keywords: ["电源", "开机", "关机", "电源键", "开关"]),
        SingleSymbols(name: "poweron",                   version: .SF1, keywords: ["开机", "电源", "竖线", "开启"]),
        SingleSymbols(name: "powersleep",                version: .SF1, keywords: ["睡眠", "月亮", "休眠", "省电", "待机"]),
        SingleSymbols(name: "alternatingcurrent",        version: .SF2, keywords: ["交流电", "电源", "波浪", "电力", "AC"]),
        ...
        SingleSymbols(name: "mount",                     version: .SF1, keywords: ["滚动", "挂载", "磁盘", "移动"]),
        SingleSymbols(name: "progress.indicator",        version: .SF5, keywords: ["加载", "进度", "等待", "转圈", "Loading"]),
        ...
        SingleSymbols(name: "sun.horizon",               version: .SF2, keywords: ["地平线", "日出", "日落", "黄昏", "清晨"]),
        SingleSymbols(name: "zzz",                       version: .SF2, keywords: ["睡眠", "休眠", "打盹", "安静", "勿扰"]),
        ...
        SingleSymbols(name: "snowflake",                 version: .SF1, keywords: ["雪花", "下雪", "冬天", "低温", "冰冻"]),
        SingleSymbols(name: "tornado",                   version: .SF2, keywords: ["龙卷风", "旋风", "风暴", "天气", "危险"]),
        SingleSymbols(name: "tropicalstorm",             version: .SF2, keywords: ["热带风暴", "台风", "飓风", "天气"]),
        SingleSymbols(name: "thermometer.variable",      version: .SF5, keywords: ["温度计", "温度", "气温", "测量", "冷热"]),
        SingleSymbols(name: "degreesign.fahrenheit",     version: .SF2, keywords: ["华氏度", "温度", "°F", "气温", "美国"]),
        SingleSymbols(name: "degreesign.celsius",        version: .SF2, keywords: ["摄氏度", "温度", "°C", "气温"]),
        SingleSymbols(name: "humidity",                  version: .SF3, keywords: ["湿度", "潮湿", "天气", "水分", "空气湿度"]),
        SingleSymbols(name: "rainbow",                   version: .SF3, keywords: ["彩虹", "天气", "颜色", "美丽", "雨后"]),
        SingleSymbols(name: "water.waves",               version: .SF4, keywords: ["水波", "波浪", "海洋", "水流", "湖泊"]),
        SingleSymbols(name: "drop",                      version: .SF1, keywords: ["水滴", "雨滴", "液体", "水", "滴落"]),
        ...
        SingleSymbols(name: "record.circle",             version: .SF1, keywords: ["录制", "录音", "录屏", "录像", "REC"]),
        ...
        SingleSymbols(name: "memories",                  version: .SF3, keywords: ["回忆", "相册", "照片", "记忆", "历史"]),
        ...
        SingleSymbols(name: "speaker.wave.3",            version: .SF1, keywords: ["声音最大", "音量最高", "扬声器", "响声"]),
        ...
        SingleSymbols(name: "righttriangle",             version: .SF2, keywords: ["直角三角形", "三角形", "几何", "形状"]),
        ...
        SingleSymbols(name: "questionmark.app",          version: .SF4, keywords: ["未知应用", "帮助", "问号", "未安装"]),
        SingleSymbols(name: "app.badge",                 version: .SF3, keywords: ["消息提示", "角标", "通知", "未读", "红点"]),
        ...
        SingleSymbols(name: "shield",                    version: .SF1, keywords: ["盾牌", "安全", "保护", "防护", "隐私"]),
        SingleSymbols(name: "shield.lefthalf.filled",    version: .SF2, keywords: ["半盾", "部分保护", "安全", "防护"]),
        SingleSymbols(name: "shield.pattern.checkered",  version: .SF4, keywords: ["格子盾", "竞技", "赛车", "保护", "游戏"]),
        ...
        SingleSymbols(name: "bell.badge",                version: .SF3, keywords: ["有通知", "未读消息", "提醒", "角标"]),
        ...
        SingleSymbols(name: "plus.viewfinder",           version: .SF1, keywords: ["扫描", "添加", "二维码", "扫码"]),
        ...
        SingleSymbols(name: "quote.opening",             version: .SF1, keywords: ["开引号", "引用", "引文", "引号"]),
        SingleSymbols(name: "quote.closing",             version: .SF1, keywords: ["关引号", "引用结束", "引文", "引号"]),
        SingleSymbols(name: "text.bubble",               version: .SF1, keywords: ["文字气泡", "消息", "聊天", "评论"]),
        SingleSymbols(name: "ellipsis.bubble",           version: .SF1, keywords: ["省略气泡", "正在输入", "聊天", "等待"]),
        SingleSymbols(name: "bubble.middle.bottom",      version: .SF2, keywords: ["底部气泡", "对话", "消息", "聊天"]),
        ...
        SingleSymbols(name: "field.of.view.ultrawide",   version: .SF4, keywords: ["超广角", "视野", "广角镜头", "全景"]),
        SingleSymbols(name: "envelope",                  version: .SF1, keywords: ["信封", "邮件", "发送", "邮件", "联系"]),
        SingleSymbols(name: "envelope.front",            version: .SF5, keywords: ["信封正面", "邮件", "发送", "写信"]),
        ...
        SingleSymbols(name: "line.3.crossed.swirl.circle", version: .SF3, keywords: ["漩涡", "清理", "平滑", "滤镜", "效果"]),
        ...
        SingleSymbols(name: "switch.2",                  version: .SF1, keywords: ["开关", "切换", "Toggle", "启用禁用"]),
        SingleSymbols(name: "slider.horizontal.3",       version: .SF1, keywords: ["水平滑块", "设置", "调节", "参数"]),
        SingleSymbols(name: "slider.vertical.3",         version: .SF3, keywords: ["垂直滑块", "调节", "设置", "参数"]),
        SingleSymbols(name: "lineweight",                version: .SF1, keywords: ["线宽", "粗细", "设计", "样式"]),
        ...
        SingleSymbols(name: "basket",                    version: .SF2, keywords: ["购物篮", "购物", "商店", "菜篮"]),
        SingleSymbols(name: "creditcard",                version: .SF1, keywords: ["信用卡", "支付", "银行卡", "付款", "金融"]),
        SingleSymbols(name: "giftcard",                  version: .SF3, keywords: ["礼品卡", "礼物", "充值", "代金券"]),
        SingleSymbols(name: "wallet.pass",               version: .SF3, keywords: ["钱包", "票务", "通行证", "Apple Pay"]),
        SingleSymbols(name: "wallet.bifold",             version: .SF4, keywords: ["对折钱包", "钱包", "支付", "卡片"]),
        SingleSymbols(name: "banknote",                  version: .SF2, keywords: ["钞票", "现金", "钱", "纸币", "金融"]),
        SingleSymbols(name: "dollarsign",                version: .SF1, keywords: ["美元", "金钱", "价格", "货币", "收入"]),
        SingleSymbols(name: "eurosign",                  version: .SF1, keywords: ["欧元", "货币", "欧洲", "金钱"]),
        ...
        SingleSymbols(name: "paintpalette",              version: .SF1, keywords: ["调色盘", "颜色", "绘画", "艺术", "配色"]),
        SingleSymbols(name: "pianokeys",                 version: .SF1, keywords: ["钢琴键", "音乐", "乐器", "演奏"]),
        ...
        SingleSymbols(name: "wrench.adjustable",         version: .SF2, keywords: ["扳手", "维修", "设置", "工具", "调整"]),
        SingleSymbols(name: "hammer",                    version: .SF1, keywords: ["锤子", "构建", "开发", "工具", "维修"]),
        SingleSymbols(name: "screwdriver",               version: .SF2, keywords: ["螺丝刀", "维修", "工具", "组装"]),
        ...
        SingleSymbols(name: "apple.meditate",            version: .SF4, keywords: ["冥想", "正念", "健康", "放松", "Apple"]),
        SingleSymbols(name: "microbe",                   version: .SF3, keywords: ["微生物", "病菌", "病毒", "感染", "健康"]),
        SingleSymbols(name: "medical.thermometer",       version: .SF2, keywords: ["体温计", "发烧", "医疗", "温度", "健康"]),
        SingleSymbols(name: "bandage",                   version: .SF2, keywords: ["绷带", "创可贴", "医疗", "伤口", "修复"]),
        SingleSymbols(name: "syringe",                   version: .SF2, keywords: ["注射器", "打针", "疫苗", "医疗", "血液"]),
        SingleSymbols(name: "facemask",                  version: .SF2, keywords: ["口罩", "防护", "医疗", "卫生", "防疫"]),
        SingleSymbols(name: "pill",                      version: .SF2, keywords: ["药丸", "药片", "医疗", "服药", "健康"]),
        SingleSymbols(name: "cross",                     version: .SF1, keywords: ["十字架", "医疗", "急救", "红十字", "加号"]),
        SingleSymbols(name: "flask",                     version: .SF4, keywords: ["烧瓶", "实验", "化学", "科学", "研究"]),
        ...
        SingleSymbols(name: "cross.case",                version: .SF4, keywords: ["急救包", "医疗包", "急救", "户外"]),
        SingleSymbols(name: "suitcase",                  version: .SF2, keywords: ["手提箱", "旅行", "出行", "行李"]),
        ...
        SingleSymbols(name: "storefront",                version: .SF4, keywords: ["店面", "商店", "零售", "商铺", "营业"]),
        ...
        SingleSymbols(name: "fan",                       version: .SF2, keywords: ["风扇", "电扇", "降温", "散热", "家电"]),
        SingleSymbols(name: "fan.ceiling",               version: .SF4, keywords: ["吊扇", "天花板风扇", "家电", "散热"]),
        SingleSymbols(name: "lamp.desk",                 version: .SF2, keywords: ["台灯", "桌灯", "照明", "学习", "办公"]),
        SingleSymbols(name: "lamp.floor",                version: .SF2, keywords: ["落地灯", "照明", "家居", "装饰"]),
        SingleSymbols(name: "lamp.ceiling",              version: .SF2, keywords: ["吊灯", "天花板灯", "照明", "家居"]),
        ...
        SingleSymbols(name: "powerplug",                 version: .SF1, keywords: ["电源插头", "充电", "电力", "插座"]),
        SingleSymbols(name: "powercord",                 version: .SF4, keywords: ["电源线", "充电线", "连接", "电力"]),
        SingleSymbols(name: "door.left.hand.open",       version: .SF2, keywords: ["开门", "退出", "出口", "进入", "门"]),
        SingleSymbols(name: "dehumidifier",              version: .SF3, keywords: ["除湿机", "除湿", "家电", "空气"]),
        SingleSymbols(name: "humidifier",                version: .SF3, keywords: ["加湿器", "加湿", "家电", "空气", "湿度"]),
        ...
        SingleSymbols(name: "shower",                    version: .SF2, keywords: ["淋浴", "洗澡", "浴室", "花洒"]),
        ...
        SingleSymbols(name: "laser.burst",               version: .SF4, keywords: ["激光", "特效", "爆发", "光线", "炫酷"]),
        SingleSymbols(name: "fireworks",                 version: .SF4, keywords: ["烟花", "庆典", "节日", "新年", "庆祝"]),
        ...
        SingleSymbols(name: "bed.double",                version: .SF2, keywords: ["双人床", "卧室", "睡眠", "家居", "休息"]),
        SingleSymbols(name: "sofa",                      version: .SF2, keywords: ["沙发", "客厅", "休息", "家居", "坐"]),
        SingleSymbols(name: "chair.lounge",              version: .SF2, keywords: ["休闲椅", "躺椅", "休息", "家居"]),
        SingleSymbols(name: "chair",                     version: .SF2, keywords: ["椅子", "座位", "坐", "家居", "桌椅"]),
        SingleSymbols(name: "table.furniture",           version: .SF2, keywords: ["桌子", "家具", "餐桌", "办公桌"]),
        SingleSymbols(name: "cabinet",                   version: .SF3, keywords: ["柜子", "橱柜", "收纳", "储物", "家具"]),
        SingleSymbols(name: "fireplace",                 version: .SF4, keywords: ["壁炉", "暖炉", "取暖", "冬天", "家居"]),
        SingleSymbols(name: "washer",                    version: .SF3, keywords: ["洗衣机", "洗衣", "清洗", "家电"]),
        SingleSymbols(name: "oven",                      version: .SF3, keywords: ["烤箱", "烘焙", "烹饪", "家电"]),
        SingleSymbols(name: "stove",                     version: .SF3, keywords: ["炉灶", "煤气灶", "烹饪", "厨房"]),
        SingleSymbols(name: "microwave",                 version: .SF3, keywords: ["微波炉", "加热", "烹饪", "家电"]),
        SingleSymbols(name: "refrigerator",              version: .SF3, keywords: ["冰箱", "冷藏", "保鲜", "家电"]),
        SingleSymbols(name: "robotic.vacuum",            version: .SF4, keywords: ["扫地机器人", "清洁", "自动打扫", "家电"]),
        SingleSymbols(name: "sink",                      version: .SF3, keywords: ["水槽", "洗手台", "洗碗", "厨房"]),
        SingleSymbols(name: "toilet",                    version: .SF3, keywords: ["马桶", "厕所", "卫生间", "洗手间"]),
        SingleSymbols(name: "stairs",                    version: .SF2, keywords: ["楼梯", "上下楼", "台阶", "建筑"]),
        ...
        SingleSymbols(name: "rotate.left",               version: .SF2, keywords: ["向左旋转", "旋转", "翻转", "顺序"]),
        ...
        SingleSymbols(name: "cone",                      version: .SF3, keywords: ["锥体", "3D", "几何", "形状"]),
        ...
        SingleSymbols(name: "opticaldisc",               version: .SF1, keywords: ["光盘", "CD", "DVD", "存储介质"]),
        ...
        SingleSymbols(name: "display",                   version: .SF1, keywords: ["显示器", "屏幕", "外接屏", "Mac"]),
        ...
        SingleSymbols(name: "iphone.gen1.crop.circle",   version: .SF4, keywords: ["iPhone圆圈", "手机图标", "应用"]),
        SingleSymbols(name: "iphone.gen1.radiowaves.left.and.right", version: .SF4, keywords: ["iPhone振动", "信号", "通话"]),
        SingleSymbols(name: "iphone.gen1.and.arrow.left", version: .SF5, keywords: ["iPhone操作", "点击", "滑动", "手势"]),
        SingleSymbols(name: "iphone.gen2.and.arrow.left.and.arrow.right.inward", version: .SF5, keywords: ["关机", "滑动关机", "iPhone"]),
        SingleSymbols(name: "iphone.and.arrow.right.outward", version: .SF5, keywords: ["退出", "迁移", "导出", "iPhone"]),
        SingleSymbols(name: "iphone.rear.camera",        version: .SF5, keywords: ["后置摄像头", "iPhone相机", "拍照"]),
        SingleSymbols(name: "platter.filled.top.iphone", version: .SF4, keywords: ["顶部通知", "iPhone顶部", "状态栏"]),
        ...
        SingleSymbols(name: "iphone.case",               version: .SF4, keywords: ["手机壳", "保护壳", "配件"]),
        SingleSymbols(name: "vision.pro",                version: .SF5, keywords: ["Vision Pro", "空间计算", "XR", "头显"]),
        SingleSymbols(name: "smartphone",                version: .SF4, keywords: ["智能手机", "手机", "移动设备"]),
        SingleSymbols(name: "applepencil",               version: .SF2, keywords: ["Apple Pencil", "手写笔", "绘图", "书写"]),
        SingleSymbols(name: "magicmouse",                version: .SF2, keywords: ["Magic Mouse", "鼠标", "苹果鼠标"]),
        SingleSymbols(name: "computermouse",             version: .SF2, keywords: ["鼠标", "电脑鼠标", "输入设备"]),
        SingleSymbols(name: "applewatch",                version: .SF2, keywords: ["Apple Watch", "智能手表", "健康", "穿戴"]),
        SingleSymbols(name: "applewatch.side.right",     version: .SF4, keywords: ["Apple Watch侧面", "表盘", "数码表冠"]),
        SingleSymbols(name: "headphones",                version: .SF1, keywords: ["耳机", "音乐", "听歌", "头戴", "降噪"]),
        SingleSymbols(name: "headset",                   version: .SF2, keywords: ["头戴耳机", "通话耳机", "客服", "游戏"]),
        SingleSymbols(name: "airpods.max",               version: .SF2, keywords: ["AirPods Max", "头戴耳机", "降噪", "音乐"]),
        SingleSymbols(name: "earbuds",                   version: .SF2, keywords: ["有线耳机", "耳塞", "音乐"]),
        SingleSymbols(name: "earbuds.case",              version: .SF2, keywords: ["耳机盒", "收纳", "充电盒"]),
        ...
        SingleSymbols(name: "hifispeaker",               version: .SF2, keywords: ["Hi-Fi音箱", "扬声器", "音响", "音乐"]),
        SingleSymbols(name: "appletv",                   version: .SF2, keywords: ["Apple TV", "流媒体", "机顶盒", "影音"]),
        SingleSymbols(name: "appletvremote.gen1",        version: .SF2, keywords: ["Apple TV遥控器", "遥控", "媒体"]),
        SingleSymbols(name: "mediastick",                version: .SF4, keywords: ["媒体棒", "流媒体", "机顶盒"]),
        SingleSymbols(name: "cable.connector",           version: .SF4, keywords: ["电缆接口", "数据线", "连接线"]),
        SingleSymbols(name: "audio.jack.mono",           version: .SF4, keywords: ["耳机插孔", "3.5mm", "音频接口"]),
        SingleSymbols(name: "tv",                        version: .SF1, keywords: ["电视", "屏幕", "影音", "媒体", "显示"]),
        SingleSymbols(name: "4k.tv",                     version: .SF2, keywords: ["4K电视", "高清", "超清", "影音"]),
        SingleSymbols(name: "airplay.video",             version: .SF1, keywords: ["AirPlay", "投屏", "无线投影", "分享屏幕"]),
        ...
        SingleSymbols(name: "pip",                       version: .SF1, keywords: ["画中画", "小窗播放", "悬浮窗", "视频"]),
        ...
        SingleSymbols(name: "bus",                       version: .SF1, keywords: ["公交车", "巴士", "公共交通", "出行"]),
        SingleSymbols(name: "tram",                      version: .SF2, keywords: ["电车", "有轨电车", "公共交通"]),
        SingleSymbols(name: "ferry",                     version: .SF2, keywords: ["轮渡", "渡船", "船只", "水运"]),
        SingleSymbols(name: "sailboat",                  version: .SF4, keywords: ["帆船", "航海", "水上", "旅行"]),
        SingleSymbols(name: "train.side.front.car",      version: .SF4, keywords: ["列车", "高铁", "火车", "铁路", "交通"]),
        SingleSymbols(name: "truck.box",                 version: .SF4, keywords: ["卡车", "货运", "物流", "运输"]),
        SingleSymbols(name: "drone",                     version: .SF4, keywords: ["无人机", "飞行", "航拍", "遥控"]),
        SingleSymbols(name: "wheelchair",                version: .SF2, keywords: ["轮椅", "无障碍", "残障", "辅助出行"]),
        SingleSymbols(name: "bicycle",                   version: .SF2, keywords: ["自行车", "骑行", "单车", "环保"]),
        SingleSymbols(name: "helmet",                    version: .SF4, keywords: ["头盔", "安全帽", "防护", "骑行"]),
        SingleSymbols(name: "moped",                     version: .SF2, keywords: ["轻便摩托", "电动车", "代步", "小型摩托"]),
        SingleSymbols(name: "motorcycle",                version: .SF2, keywords: ["摩托车", "骑行", "两轮", "交通"]),
        SingleSymbols(name: "scooter",                   version: .SF4, keywords: ["踏板车", "代步", "滑板车", "电动"]),
        ...
        SingleSymbols(name: "tirepressure",              version: .SF4, keywords: ["胎压", "轮胎气压", "安全", "维保"]),
        ...
        SingleSymbols(name: "yieldsign",                 version: .SF4, keywords: ["让行", "让路标志", "减速", "交通"]),
        ...
        SingleSymbols(name: "tire",                      version: .SF4, keywords: ["轮胎", "车轮", "汽车", "维保"]),
        SingleSymbols(name: "tow.hitch",                 version: .SF4, keywords: ["拖车钩", "牵引", "拖挂", "连接"]),
        SingleSymbols(name: "carseat.left",              version: .SF4, keywords: ["汽车座椅", "儿童座椅", "安全座椅"]),
        SingleSymbols(name: "car.side",                  version: .SF4, keywords: ["汽车侧面", "轿车", "出行", "车型"]),
        SingleSymbols(name: "car.side.front.open.crop",  version: .SF5, keywords: ["车门", "前排", "上车", "汽车"]),
        SingleSymbols(name: "car.side.rear.open.crop",   version: .SF5, keywords: ["后备箱", "行李", "尾门", "汽车"]),
        SingleSymbols(name: "suv.side",                  version: .SF4, keywords: ["SUV", "越野车", "汽车", "车型"]),
        SingleSymbols(name: "truck.pickup.side",         version: .SF4, keywords: ["皮卡", "货车", "越野", "车型"]),
        SingleSymbols(name: "convertible.side",          version: .SF4, keywords: ["敞篷车", "跑车", "车型", "豪车"]),
        SingleSymbols(name: "car.top.door.front.left.open", version: .SF4, keywords: ["开车门", "进入", "汽车俯视"]),
        SingleSymbols(name: "suspension.shock",          version: .SF4, keywords: ["减震器", "悬架", "弹簧", "汽车"]),
        ...
        SingleSymbols(name: "dog",                       version: .SF2, keywords: ["狗", "宠物", "可爱", "动物", "汪"]),
        SingleSymbols(name: "cat",                       version: .SF2, keywords: ["猫", "宠物", "可爱", "动物", "喵"]),
        ...
        SingleSymbols(name: "ladybug",                   version: .SF1, keywords: ["瓢虫", "昆虫", "Debug", "Bug", "调试"]),
        SingleSymbols(name: "fish",                      version: .SF1, keywords: ["鱼", "海鲜", "水产", "动物", "钓鱼"]),
        SingleSymbols(name: "pawprint",                  version: .SF2, keywords: ["爪印", "宠物", "足迹", "动物"]),
        SingleSymbols(name: "teddybear",                 version: .SF2, keywords: ["泰迪熊", "玩具", "礼物", "可爱"]),
        ...
        SingleSymbols(name: "hat.widebrim",              version: .SF3, keywords: ["宽檐帽", "遮阳帽", "时尚", "夏天"]),
        SingleSymbols(name: "hat.cap",                   version: .SF3, keywords: ["鸭舌帽", "棒球帽", "休闲", "时尚"]),
        SingleSymbols(name: "tshirt",                    version: .SF2, keywords: ["T恤", "衣服", "服装", "穿搭"]),
        SingleSymbols(name: "jacket",                    version: .SF4, keywords: ["夹克", "外套", "服装", "穿搭"]),
        ...
        SingleSymbols(name: "ticket",                    version: .SF1, keywords: ["门票", "票务", "活动", "电影票", "演出"]),
        ...
        SingleSymbols(name: "sunglasses",                version: .SF3, keywords: ["太阳镜", "墨镜", "时尚", "防晒"]),
        ...
        SingleSymbols(name: "xmark.triangle.circle.square", version: .SF3, keywords: ["多图形", "组合", "快捷键", "多操作"]),
        SingleSymbols(name: "hand.raised.palm.facing",   version: .SF4, keywords: ["手掌", "停止", "阻止", "禁止"]),
        ...
        SingleSymbols(name: "chart.dots.scatter",        version: .SF3, keywords: ["散点图", "数据", "分布", "统计"]),
        ...
        SingleSymbols(name: "dpad",                      version: .SF1, keywords: ["方向键", "游戏手柄", "上下左右", "控制"]),
        ...
        SingleSymbols(name: "mug",                       version: .SF3, keywords: ["马克杯", "咖啡杯", "饮品", "办公"]),
        SingleSymbols(name: "wineglass",                 version: .SF2, keywords: ["酒杯", "红酒", "饮品", "聚餐"]),
        SingleSymbols(name: "waterbottle",               version: .SF4, keywords: ["水瓶", "饮水", "运动水壶", "健康"]),
        ...
        SingleSymbols(name: "angle",                     version: .SF3, keywords: ["角度", "几何", "度数", "数学"]),
        ...
        SingleSymbols(name: "plus.forwardslash.minus",   version: .SF1, keywords: ["加减", "正负", "切换", "对比"]),
        ...
        SingleSymbols(name: "arrow.up.and.down.and.arrow.left.and.right", version: .SF1, keywords: ["移动", "拖动", "选中", "全向"]),
        SingleSymbols(name: "arrow.down.left.and.arrow.up.right", version: .SF1, keywords: ["放大", "全屏", "展开", "扩大"]),
        SingleSymbols(name: "arrow.down.right.and.arrow.up.left", version: .SF1, keywords: ["缩小", "退出全屏", "收起"]),
        SingleSymbols(name: "arrow.3.trianglepath",      version: .SF3, keywords: ["三向循环", "刷新", "循环", "重复"]),
        SingleSymbols(name: "arrow.trianglehead.merge",  version: .SF5, keywords: ["合并", "Git合并", "汇聚", "连接"]),
        SingleSymbols(name: "arrow.trianglehead.branch", version: .SF5, keywords: ["分支", "Git分支", "派生", "分叉"]),
        SingleSymbols(name: "arrow.trianglehead.swap",   version: .SF5, keywords: ["交换", "互换", "切换", "连接"]),
        SingleSymbols(name: "arrow.down.left.arrow.up.right", version: .SF4, keywords: ["传输", "转换", "双向", "箭头"]),
        ...
        SingleSymbols(name: "arrowshape.up",             version: .SF3, keywords: ["上箭头", "向上", "方向", "提交"]),
        SingleSymbols(name: "arrowshape.down",           version: .SF3, keywords: ["下箭头", "向下", "下载", "方向"]),
